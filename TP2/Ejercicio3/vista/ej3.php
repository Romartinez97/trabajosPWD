...
<body>
    <form action="./action/verificaPass.php" method="post" name="form-login" id="form-login">
        <h2>Member Login</h2>
        Usuario: <br>
        ...
        <input type="password" name="contrasenia" id="contrasenia" class="form-control"><br><br>
